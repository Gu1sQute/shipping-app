...
// 新增 handleRemoveItemFromOrder 函式
const handleRemoveItemFromOrder = (productIdToRemove) => {
  setOrder(prevOrder => ({
    ...prevOrder,
    // 使用 filter 函式創建一個新陣列，排除掉要刪除的品項
              ...
              <table style={{ width: '100%', borderCollapse: 'collapse', marginTop: '10px' }}>
                <thead>
                  <tr style={{ background: '#f2f2f2' }}>
                    ...
                    <th style={{ border: '1px solid #ddd', padding: '8px', textAlign: 'center' }}>操作</th> {/* 新增操作欄位 */}
                  </tr>
                </thead>
                <tbody>
